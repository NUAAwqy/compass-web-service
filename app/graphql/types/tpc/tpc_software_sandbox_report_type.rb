...
module Types
  module Tpc
    class TpcSoftwareSandboxReportType < Types::BaseObject
      ...
      field :tpc_software_sandbox_report_metric, Types::Tpc::TpcSoftwareSandboxReportMetricType
      field :tpc_software_sandbox_report_metric_raw, Types::Tpc::TpcSoftwareSandboxReportMetricRawType
      ...
      def tpc_software_sandbox_report_metric
        TpcSoftwareSandboxReportMetric.find_by(
          tpc_software_sandbox_report_id: object.id,
      ...
      def tpc_software_sandbox_report_metric_raw
        report_metric = tpc_software_sandbox_report_metric
        if report_metric.present?
          TpcSoftwareSandboxReportMetricRaw.find_by(tpc_software_report_metric_id: report_metric.id)
        end
      end
